...
public class Robot extends TimedRobot {
  ...
  CANSparkMax leftFrontMotor = new CANSparkMax(driveFrontleftMotor, MotorType.kBrushless);
  CANSparkMax leftBackMotor = new CANSparkMax(driveBackleftMotor, MotorType.kBrushless);

  CANSparkMax rightFrontMotor = new CANSparkMax(driveFrontrightMotor, MotorType.kBrushless);
  CANSparkMax rightBackMotor = new CANSparkMax(driveBackrightMotor, MotorType.kBrushless);

  private SpeedControllerGroup m_LeftMotors = new SpeedControllerGroup(leftFrontMotor, leftBackMotor);
  private SpeedControllerGroup m_RightMotors = new SpeedControllerGroup(rightFrontMotor, rightBackMotor);
